...
import parinton
from parinton.types import AverageDateReturnType, ArtworkDictType, ArtworkReturnType, CacheData, BaseLiterals
from parinton.utils import page_req, load_file, format_time, save_file
...
class PacoArtParser(parinton.Parinton):
